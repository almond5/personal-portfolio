        ...
        <div className="mx-auto text-xl text-left max-w-3xl">
          ...
          <div className="mb-6 text-2xl text-left">
            <div className="mb-3">
              ...
              assistant, I hosted office hours, administered exams, and graded
              several assignments.
            </div>
            <div className="mb-3">
              ...
              real-world experience by creating scalabale/dynamic applications
              and writing documentation. I was also able to further develop my
            ...
            <div className="mb-3">
              As a swe intern, I developed a dynamic debugging dashboard for
              Bing Feeds research metrics in collaboration with Bing&apos;s
              Beijing team. I also collaborated with a Senior Applied Data
              Scientist to create an up-sampling mechanism that up-sampled
              underrepresented exploration paths.
            </div>
          </div>
