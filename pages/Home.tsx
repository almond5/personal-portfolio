...
const Home = () => {
  return (
    <div>
      <div id="home" className="py-64 flex-col justify-center text-center">
        ...
        <div
          className="mx-auto max-w-sm text-xl text-left xs:max-w-sm sm:max-w-sm md:max-w-sm 
        ...
        <div className="py-14 mx-auto max-w-2xl">
